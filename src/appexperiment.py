...
print("Built server list time " + str(datetime.timedelta(seconds= time.time()) - datetime.timedelta(seconds= startTime)))
datacenters = []

for x in servers.keys():
    datacenters.append(x)
print("Built datacenter list time " + str(datetime.timedelta(seconds= time.time()) - datetime.timedelta(seconds= startTime)))
...
itemsDataLocation = 'G:/OneDrive/MyDashApp/src/item.csv'
print("Built first graph object time " + str(datetime.timedelta(seconds= time.time()) - datetime.timedelta(seconds= startTime)))
allItems = listAllItems(itemsDataLocation)
print("Built itemList list time " + str(datetime.timedelta(seconds= time.time()) - datetime.timedelta(seconds= startTime)))
allItemNames = allItems['Name']
print("Built item list name list time " + str(datetime.timedelta(seconds= time.time()) - datetime.timedelta(seconds= startTime)))
...
def uponClick(itemList, numOfHours, weeksSlider, includeMats, includeSales, onlyHQ, n_clicks, dataCenterSelected, serverList):
    ...
    startTime = time.time()
    print("Started first query list time " + str(datetime.timedelta(seconds= startTime)))
    ...
    for name in itemList:
        ...
        print("Performed " + str(i) + " item lookup, time " + str(datetime.timedelta(seconds= time.time()) - datetime.timedelta(seconds= startTime)))
        ...
        if thisListDF['isCrafted'][0] == 1 and showMaterials == True:
            ...
            print("Performed " + str(i) + " material lookup time " + str(datetime.timedelta(seconds= time.time()) - datetime.timedelta(seconds= startTime)))
