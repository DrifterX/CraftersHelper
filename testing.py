...
serverByID = environment.serverByID
...
itemList = ['Sunset Carrot Nibbles']
itemName = itemList[0]
craftedItemName = itemName
daysSlider = 14
weeksSlider = daysSlider / 7
weeksToShow = weeksSlider
numOfWeeks = weeksSlider
returnServer = "Aether"
showMaterials = True
datacenter = "Aether"
dataCenterSelected = "Aether"
serverList = None
hqOnly = True
numOfHours = 12
numOfSteps = int((168 / numOfHours) * numOfWeeks)
